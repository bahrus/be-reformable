...
- Name: tests\NewtonMicroservice\BaseLink.spec.mjs >> test1
- Location: tests\NewtonMicroservice\BaseLink.spec.mjs:2:1
...
```ts
  ...
  3 |     await page.goto('./tests/NewtonMicroservice/BaseLink.html');
  4 |     // wait for 1 second
